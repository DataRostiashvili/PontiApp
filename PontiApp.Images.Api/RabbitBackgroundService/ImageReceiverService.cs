        ...
        private async void Consumer_Received(object sender, BasicDeliverEventArgs e)
        {
            ...
            switch (e.RoutingKey)
            {
                case RabbitMQConsts.UPDATE_ADD_Q:
                    ...
                    _logger.LogInformation($"Message consummed from {RabbitMQConsts.UPDATE_ADD_Q} queue at {DateTime.Now}");
                    break;
                ...
                case RabbitMQConsts.DELETE_Q:
                    ...
                    _logger.LogInformation($"Message consummed from {RabbitMQConsts.DELETE_Q} queue at {DateTime.Now}");
                    break;
            }
        }

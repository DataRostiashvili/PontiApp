...
namespace PontiApp.Images.Services.PlaceService
{
    public class MongoPlaceService:IMongoUserService
    {
        private readonly IMongoRepository<PlaceSchema> repo;
        public MongoPlaceService(IMongoRepository<PlaceSchema> _repo)
        {
            repo = _repo;
        }
        ...
        public async Task PostImage(string schemaID, List<byte[]> list)
        {
            ...
            dict.Add("PlaceSchemaID", schemaID);
